...
class RobotNavigator(Node):
    ...
    def followPath(self, path, controller_id='', goal_checker_id='general_goal_checker'):
    ...
    def getPathThroughPoses(self, start, goals, planner_id='GridBased', use_start=False):
